...
export type PolicyCondition = {
    ...
    type: "max_value_token";
    token: string;
    threshold: bigint;
} | {
    type: "daily_limit_usd";
    threshold: number;
} | {
    type: "monthly_limit_usd";
    threshold: number;
} | {
    type: "allowed_contracts";
    addresses: string[];
} | {
    type: "blocked_contracts";
    addresses: string[];
} | {
    type: "allowed_functions";
    selectors: string[];
} | {
    type: "blocked_functions";
    selectors: string[];
} | {
    type: "allowed_chains";
    chainIds: string[];
    ...
    type: "require_key_tier";
    minTier: "root" | "operator" | "agent";
} | {
