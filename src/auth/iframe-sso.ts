 ...
 */
export async function createIframeSession(
 ...
 */
export function createPostMessagePayload(session: AuthSession): {
  type: "MACHINA_AUTH";
  sessionId: string;
  token: AuthToken;
  expiresAt: string;
 ...
 */
export function parsePostMessagePayload(data: unknown): AuthSession | null {
  ...
  return {
    ...
    token: token as unknown as AuthToken,
 ...
 */
export function revokeIframeSession(_sessionId: string): void {
