 ...
 */
export function buildIdentityRegistration(
  ...
  const registrationCalldata = encodeRegisterAgent(
    vaultAddress,
    request.name,
    kya.contentHash,
  );
 ...
 */
export function updateKYACompliance(
  kya: KYAMetadata,
  sanctionsScreened: boolean,
  jurisdictions: string[],
): KYAMetadata {
  const updated: KYAMetadata = {
    ...kya,
    compliance: {
      ...kya.compliance,
      sanctionsScreened,
