 ...
 */
function deriveGeneratorH(): ProjectivePoint {
...
let _generatorH: ProjectivePoint | null = null;

function getGeneratorH(): ProjectivePoint {
  if (_generatorH === null) {
...
export function hashCommit(
  data: Uint8Array,
  randomness?: Uint8Array,
): { commitment: Uint8Array; opening: Uint8Array } {
  const r = randomness ?? randomBytes(32);
 ...
 */
export function hashCommitment(data: Uint8Array): Uint8Array {
  return sha256(data);
}
