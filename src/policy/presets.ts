...
function makeRule(partial: Omit<PolicyRule, "id" | "createdAt" | "createdBy"> & { idPrefix: string }): PolicyRule {
 ...
 */
export function CONSERVATIVE_PRESET(): PolicyRule[] {
  return [
    makeRule({
      idPrefix: "cons",
 ...
 */
export function STANDARD_PRESET(): PolicyRule[] {
  return [
    makeRule({
      idPrefix: "std",
 ...
 */
export function AGGRESSIVE_PRESET(): PolicyRule[] {
  return [
    makeRule({
      idPrefix: "agg",
 ...
 */
export function LOCKDOWN_PRESET(): PolicyRule[] {
  return [
    makeRule({
      idPrefix: "lock",
