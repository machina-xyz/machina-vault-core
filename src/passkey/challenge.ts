 ...
 */
export function generateChallenge(): VaultChallenge {
 ...
 */
export function validateChallenge(challenge: VaultChallenge): boolean {
  if (challenge.used) {
    return false;
  }
 ...
 */
export function markChallengeUsed(challenge: VaultChallenge): void {
  challenge.used = true;
}
